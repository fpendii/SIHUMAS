...
class KoorEditFotoController extends Controller
{
    ...
    public function proses()
    {
        ...
        return view('pages.koordinator.kelola_edit_foto.proses-edit_foto', $data);
    ...
    public function detailProses($id){
        ...
        return view('pages.koordinator.kelola_edit_foto.detail-proses_edit_foto',$data,compact('dataPermohonan'));
    }
    ...
    public function detailArsip(Request $request, $id)
    {
        ...
        return view('pages.koordinator.kelola_edit_foto.detail-arsip-edit-foto', $data, compact('dataPermohonan'));
    }
