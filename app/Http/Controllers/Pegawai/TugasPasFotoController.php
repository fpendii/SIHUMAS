...
class TugasPasFotoController extends Controller
{
    public function detailTugas($id){
        ...
        return view('pages.petugas.kelola_tugas.tugas_pas_Foto',$data,compact('dataPermohonan','dataPetugas','dataPetugasPesanan'));
    }
