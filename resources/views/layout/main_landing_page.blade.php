                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-7 col-12">
                        ...
                        <ul class="top-contact">
                            <li><i class="fa fa-phone"></i>politala</li>
            ...
            <div class="single-slider" style="background-image:url('images/hero_1.png')">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-7">
                            <div class="text">
                                <h1>Sistem Informasi <span>Permohonan</span> Jasa <span>Humas Politeknik Negeri Tanah
                                        Laut</span></h1>
            ...
            <div class="row">
                <div class="col-lg-4 col-12">
                    ...
                    <div class="single-features">
                        ...
                        <h3>Peliputan</h3>
                        <p>Peliputan adalah kegiatan jurnalisme atau media yang melibatkan pengumpulan, penyuntingan, dan penyampaian informasi atau berita melalui berbagai media seperti tulisan, foto, video, atau audio.</p>
                    </div>
                    <!-- End Single features -->
                </div>
                <div class="col-lg-4 col-12">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="section-title">
                        <h2>About Us</h2>
                        <p>Visi dan Misi Kami Humas Politala</p>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="">
                    ...
                    <div class="choose-left">
                        <h3>Visi</h3>
                        <p>Menyediakan Informasi Publik yang Aktual, Transparan dan Humanis sebagai Pendukung Visi dan
                            Misi Institusi</p>
                        <hr>
                        <h3>Misi</h3>
                        ...
                        <div class="row">
                            <div class="">
                                <ol class="list ml-4">
                                    ...
                                    <li>Memperkuat pelayanan informasi melalui media massa dan media-media lainnya</li>
                                </ol>
                            </div>
            ...
            <div class="row">
                <div class="col-lg-12 col-12">
                    <div class="owl-carousel portfolio-slider">
                        <div class="single-pf">
                            <img src="template_landing_page/img/pf1.jpg" alt="#">
                            <a href="portfolio-details.html" class="btn">View Details</a>
                        </div>
                        <div class="single-pf">
                            <img src="template_landing_page/img/pf2.jpg" alt="#">
                            <a href="portfolio-details.html" class="btn">View Details</a>
                        </div>
                        <div class="single-pf">
                            <img src="template_landing_page/img/pf3.jpg" alt="#">
                            <a href="portfolio-details.html" class="btn">View Details</a>
                        </div>
                        <div class="single-pf">
                            <img src="template_landing_page/img/pf4.jpg" alt="#">
                            <a href="portfolio-details.html" class="btn">View Details</a>
                        </div>
                        <div class="single-pf">
                            <img src="template_landing_page/img/pf1.jpg" alt="#">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="section-title">
                        ...
                        <p>Tersedia pilihan layanan yang lengkap dari Humas Politala, siap untuk mendukung dan memenuhi
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6 col-12">
                    ...
                    <div class="single-service">
                        ...
                        <h4><a href="service-details.html">Editing Foto</a></h4>
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec luctus dictum eros ut
                            imperdiet. </p>
                    </div>
                    <!-- End Single Service -->
                ...
                <div class="col-lg-4 col-md-6 col-12">
                    ...
                    <div class="single-service">
                        ...
                        <h4><a href="service-details.html">Pas Foto</a></h4>
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec luctus dictum eros ut
                            imperdiet. </p>
                    </div>
                    <!-- End Single Service -->
                ...
                <div class="col-lg-4 col-md-6 col-12">
                    ...
                    <div class="single-service">
                        ...
                        <h4><a href="service-details.html">Peliputan</a></h4>
                        <p >Peliputan adalah kegiatan jurnalisme atau media yang melibatkan pengumpulan, penyuntingan, dan penyampaian informasi atau berita melalui berbagai media seperti tulisan, foto, video, atau audio. </p>
                    </div>
                    <!-- End Single Service -->
                </div>
                <div class="col-lg-4 col-md-6 col-12">
                    ...
                    <div class="single-service">
                        ...
                        <h4><a href="service-details.html">Pemberitaan dan Publikasi</a></h4>
                        <p>Pemberitaan dan publikasi adalah proses menyebarkan informasi atau berita kepada khalayak melalui media cetak, elektronik, online, atau platform lainnya. </p>
                    </div>
                    <!-- End Single Service -->
                </div>
                <div class="col-lg-4 col-md-6 col-12">
                    ...
                    <div class="single-service">
                        ...
                        <h4><a href="service-details.html">Editing Video</a></h4>
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec luctus dictum eros ut
                            imperdiet. </p>
                    </div>
                    <!-- End Single Service -->
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6 col-12">
                    ...
                    <div class="single-news">
                        <div class="news-head">
                            <img src="template_landing_page/img/blog1.jpg" alt="#">
                        </div>
                        <div class="news-body">
                ...
                <div class="col-lg-4 col-md-6 col-12">
                    ...
                    <div class="single-news">
                        <div class="news-head">
                            <img src="template_landing_page/img/blog2.jpg" alt="#">
                        </div>
                        <div class="news-body">
                            <div class="news-content">
                ...
                <div class="col-lg-4 col-md-6 col-12">
                    ...
                    <div class="single-news">
                        <div class="news-head">
                            <img src="template_landing_page/img/blog3.jpg" alt="#">
                        </div>
                        <div class="news-body">
                            <div class="news-content">
                ...
                <div class="col-lg-12 col-md-12 col-12">
                    <div class="owl-carousel clients-slider">
                        <div class="single-clients">
                            <img src="template_landing_page/img/client1.png" alt="#">
                        </div>
                        <div class="single-clients">
                            <img src="template_landing_page/img/client2.png" alt="#">
                        </div>
                        <div class="single-clients">
                            <img src="template_landing_page/img/client3.png" alt="#">
                        </div>
                        <div class="single-clients">
                            <img src="template_landing_page/img/client4.png" alt="#">
                        </div>
                        <div class="single-clients">
                            <img src="template_landing_page/img/client5.png" alt="#">
                        </div>
                        <div class="single-clients">
                            <img src="template_landing_page/img/client1.png" alt="#">
                        </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-md-12 ">
                    <div class="appointment-image">
                        <img src="template_landing_page/img/contact-img.png" alt="#">
                    </div>
                </div>
            </div>
        </div>
