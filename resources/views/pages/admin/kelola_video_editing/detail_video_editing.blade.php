...
<body>
    ...
    <nav class="navbar navbar-light">
        <div class="container d-block">
            <a href="{{ url('admin/video-editing') }}"><i class="bi bi-chevron-left"></i></a>
            ...
            <div class="card">
                <div class="card-content">
                    <div class="card-body">
                        ...
                        <form action="{{url('admin/video-editing/pilih-petugas/'.$dataPermohonan->id_pesanan)}}" class="form" method="post">
                            @csrf
                            @method('PUT')
