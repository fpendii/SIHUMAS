...
<body>
    ...
    <header class="header">
        ...
        <section class="why-choose section">
            <div style="transform: translateY(-40px)" class="container">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col">
                            ...
                            <p>Menyediakan Informasi Publik yang Aktual, Transparan dan Humanis sebagai Pendukung Visi
                                dan
                                Misi Institusi</p>
                        </div>
                        <div class="col">
                            ...
                            <div class="row">
                                <div class="">
                                    <ol class="list ml-4">
                                        ...
                                        <li>Menjalin kerjasama yang harmonis dengan pihak internal dan mitra institusi
                                            dalam
                                            pelaksanaan Tri Dharma Perguruan Tinggi.</li>
                                        <li>Memperkuat pelayanan informasi melalui media massa dan media-media lainnya
                                        </li>
                                    </ol>
                                </div>
